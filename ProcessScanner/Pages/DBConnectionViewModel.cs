...
namespace PhoneBook.Pages
{
    ...
    {
        string connectionString = "Data Source=KALAIDERXPPC;Database=KIS;User ID=sa;Password=sa;Connection Timeout=3;";
        ...
        public DBConnectionViewModel()
        {
            ...
            var resourceName = "ProcessScanner.create_schema.sql";
        ...
        public string ConnectionString
        {
            ...
            set { this.connectionString = value; OnPropertyChanged("ConnectionString"); }
        }
        public string SqlString
        {
            get { return sqlString; }
            set { this.sqlString = value; OnPropertyChanged("SqlString"); }
        }
